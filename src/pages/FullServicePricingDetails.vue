...
<script lang="ts">
  ...
  import { FullServicePricingDetails } from '../data/messages/FullServicePricingDetails'; // Import messages specific to Full Service Pricing Details
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const messages = FullServicePricingDetails; // Load messages for Full Service Pricing Details
