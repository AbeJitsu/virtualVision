...
<script lang="ts">
  ...
  import { CompleteProcessSummary } from '../data/messages/CompleteProcessSummary'; // Import messages specific to the Summary Without Pricing page
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const messages = CompleteProcessSummary; // Load messages for Summary Without Pricing
